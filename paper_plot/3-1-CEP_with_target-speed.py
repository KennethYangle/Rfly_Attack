...
data = []
# 5m/s
f = open(os.path.join("../datas","datas_5mps.pkl"), 'r')
datas_raw = pickle.load(f)
data.append(datas_raw)
# 7.5m/s
f = open(os.path.join("../datas","datas_7_5mps.pkl"), 'r')
datas_raw = pickle.load(f)
data.append(datas_raw)
# 10m/s
f = open(os.path.join("../datas","datas_10mps.pkl"), 'r')
datas_raw = pickle.load(f)
data.append(datas_raw)
...
fig.savefig("../output/CEP_with_speed.svg", format='svg', bbox_inches='tight')
svg_to_emf("../output/CEP_with_speed.svg")
plt.show()
