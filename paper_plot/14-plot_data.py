...
def main(args):
    ...
    if args.subplot > 0:
        ...
        fig.savefig("../output/subplot-real.svg", format='svg', bbox_inches='tight')
        svg_to_emf("../output/subplot-real.svg")
        plt.show()
    ...
    if not args.self and not args.plotxy and args.subplot<=0:
        ...
        for i in range(len(datas[0])):
            ...
            # plt.legend(loc='upper center')
        fig.savefig("../output/local-real-moving-2.svg", format='svg', bbox_inches='tight')
        svg_to_emf("../output/local-real-moving-2.svg")
        plt.show()
